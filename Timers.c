...
/**********************************************************************************************************************************/
 ...
 static uint8_t gu8_PreScaler_T0       = 0;
 static uint8_t gu8_PreScaler_T1       = 0;
 static uint8_t gu8_PreScaler_T2       = 0;
 static uint8_t au8_Temp_For_Low_Bit   = 0;
 static uint8_t au8_Temp_For_Hight_Bit = 0;
    ...
    uint8_t Error = E_OK;
	 switch (Timer_Chan)
	 {
		 ...
		 if (TIMER1_MAX_NUMBER_OF_COUNTS >= Timer_Count_No)
		 {
			 ...
			 au8_Temp_For_Hight_Bit = ((TIMER1_MAX_NUMBER_OF_COUNTS - Timer_Count_No) >>8);
	    ...
	    switch (Timer_Chan)
		 {
			 ...
			 *Timer_Value = (au8_Temp_For_Low_Bit | (au8_Temp_For_Hight_Bit <<8));
			 break;
 ...
 uint8_t Timer_Set_Value (uint8_t Timer_Chan, uint16_t Timer_Value)
 {
	 ...
	 switch (Timer_Chan)
    {
	    ...
	    au8_Temp_For_Hight_Bit = (Timer_Value >>8);
